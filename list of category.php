...
<div class="container bg-light ">
    ...
    echo "<table class='table table-secondary table-striped table-hover'><tr><th>Category</th><th>Date</th><th>Action</th></tr>";
    ...
    while($data=mysqli_fetch_assoc($query)){
		...
		<td>
		<a href='edit category.php?id=$Category_id' class='btn btn-secondary'>
		Edit
		</a>
		</td>
		</tr>";
